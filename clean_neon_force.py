#!/usr/bin/env python3
"""
Force clean Neon database - Remove all test extraction data without prompts.
...
async def force_clean_database():
    """Force clean all extraction data from Neon database."""
    print("🧹 Force Cleaning Neon Database - Removing All Test Data")
    print("=" * 60)
    ...
    try:
        ...
        with psycopg2.connect(conn_str) as conn:
            with conn.cursor() as cur:
                ...
                # 2. Clean the database (order matters due to foreign key constraints)
                cleanup_order = [
...
async def main():
    ...
    print("   The Neon database and local states are now clean.")
    print("   Ready for fresh testing with a clean slate.")
    print("=" * 60)
